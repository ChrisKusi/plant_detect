...
//
//     try {
//       final uri = Uri.parse('http://192.168.50.79:5000/detect');
...
//         _image = File(pickedImage.path);
//         objDetect = [];
//         _getLocation(); // Get the location when a new image is picked
//       });
//     }
//   }
// }
...
//
//   final Map<String, Map<String, String>> diseaseSolutions = {
//     // Add your disease solutions and best practices here
//   };
//
//   @override
//   void initState() {
...
class _HomeState extends State<Home> {
  ...
  'Apple Scab Leaf': {
    ...
    // Add other diseases and their respective solutions and best practices here
  };
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (pickedImage != null) {
      ...
      setState(() {
        _image = file;
        objDetect = [];
        _getLocation(); // Refresh the location when a new image is picked
      });
    }
  }
}
